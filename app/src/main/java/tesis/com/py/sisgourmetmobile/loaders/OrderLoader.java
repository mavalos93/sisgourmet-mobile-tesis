...
public class OrderLoader extends AsyncTaskLoader<List<Order>> {
    ...
    private OrdersObserver mObserver = null;
    ...
    public List<Order> loadInBackground() {
        mData = OrderRepository.getAllOrder();
        return mData;
    }
    ...
    protected void onStartLoading() {
        ...
        if (mObserver == null) {
            mObserver = new OrdersObserver(this);
        }
    ...
    private void releaseResources(List<Order> data) {
