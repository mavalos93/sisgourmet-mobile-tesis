...
public class ProviderRating {
    ...
    public ProviderRating(Long id, String providerName, Integer maxRating, String providerRating, Integer totalUserComments, byte[] providerImage, Integer fiveStar, Integer fourStar, Integer threeStar, Integer twoStar, Integer oneStar) {
        this.id = id;
