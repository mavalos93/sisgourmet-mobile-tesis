...
import tesis.com.py.sisgourmetmobile.recivers.CommetViewObserver;
...
public class CommetViewLoader extends AsyncTaskLoader<List<Qualification>> {

    private CommetViewObserver mObserver = null;
    private List<Qualification> mData;


    public CommetViewLoader(Context context) {
        super(context);
    }
    ...
    protected void onStartLoading() {
        ...
        if (mObserver == null) {
            mObserver = new CommetViewObserver(this);
        }
